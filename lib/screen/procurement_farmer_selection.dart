...
class _ProcurementFarmerSelectionScreenState
              ...
              GFCard(
                ...
                content: TextField(
                  ...
                  decoration: const InputDecoration(
                    hintText:
                        'Search Farmer Name / Tracenet Id / Mobile Number',
                  ),
                  onChanged: (text) => getFarmers(text),
                ),
              ),
              ...farmersList.map(
                (farmer) => GFListTile(
  ...
  void getFarmers(String searchText) async {
    ...
    farmers.where((element) =>
        element.name!.contains(searchText) ||
        element.code!.contains(searchText) ||
        element.mobileNumber!.contains(searchText));
